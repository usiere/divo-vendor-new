    ...
    <nav class="navbar navbar-expand-lg navbar-light py-3">
     <h1>My Profile</h1>
      <div class="mb-4">
            ...
            <a v-b-modal.past-orders hide-backdrop href="#" class="past btn btn-success ml-2">View past orders</a>
        </div>
    </nav>
...
<div class="container">
  <!-- <div class="card">
   	...
   	<span class="logo-lg">
					<img src="@assets/images/logo-white.png" width="70" height="35" /> User ID
					<span class="d-inline h5 ml-2 text-logo"></span>
				</span>
 <label class="cardtext">{{user_main.divoid}}</label>

  </div> -->
  <div >
 <div class="col"> </br> <strong> <p>Account type:</p> </strong>
    <h2 class="cost">DIVO-HM</h2><br>
    <strong><p>City:</p></strong>
    <h2 class="seller">{{user_main.city}}</h2>
     <strong><p>District:</p></strong>
    <h2 class="seller">{{user_main.district}}</h2>
    </div>
    <div class="col">
     </br>
       <strong><p>Address:</p> </strong>
      <p class="bought-items description">{{user_main.address}}</p>
     <br>
       <strong><p>Phone Number:</p> </strong>
      
      <p class="bought-items description">1 - {{user_main.phone1}}</p>
      <p class="bought-items description">2 - {{user_main.phone1}}</p><br>
    </div>
